...
<section class="section content" id="sponsorus">
    ...
    <!--
    For each sponsor display the paragraph about them then their picture
    -->
    <div class="container">
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <a href="http://ptc.com"><img src="/img/sponsor/ptc.png"></a>
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-5">
                <a href="https://www.aircycler.com/"><img src="/img/sponsor/AirCycler.jpg" width="500px" height="50%"></a>
            </div>
            <div class="col-md-7">
                <p class="lead">
        ...
        <div class="row featurette">
            <div class="col-md-5">
                <a href="http://www.duxburyeducationfoundation.org/"><img src="/img/DEF.png"></a>
            </div>
            <div class="col-md-7">
                <p class="lead">
