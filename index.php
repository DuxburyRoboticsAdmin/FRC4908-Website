          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class=""><a href="engineering"><span class="glyphicon glyphicon-apple"></span> Engineering Week</a></li>
	  ...
	  <br>
			<div class="container well">
				<center>
					...
					<br>
					<a class="btn btn-primary btn-lg" role="button" href="sponsorus/">Sponsor Us</a>
				</center>
			</div>
		  </div>
	  <br>
                       ...
                       <img src="img/teambanner.JPG">
                        <center>
                            <div class="caption">
                                ...
                                <p><a href="team/" class="btn btn-primary" role="button">Learn More</a></p>
                                <hr>
