...
<div class="btn-group" role="group" aria-label="...">
  <a href="../admin/resources/"><button type="button" class="btn btn-info btn-lg">Resource Login</button></a>
    <a href="Resources.php"><button type="button" class="btn btn-info btn-lg">Resource Register</button></a>
</div>
</center>          
